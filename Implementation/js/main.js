...
function createVis(data) {
    ...
    document.getElementById("genButtons").innerHTML +=
        ' <img src="img/utils/numAll.jpg" alt="All" width="54" height="53" onclick="pokeCluster.wrangleData(0)">\n' +
        '            <img src="img/utils/numOne.jpg" alt="One" width="54" height="53" onclick="pokeCluster.wrangleData(1)">\n' +
        '            <img src="img/utils/numTwo.jpg" alt="Two" width="54" height="53" onclick="pokeCluster.wrangleData(2)">\n' +
        '            <img src="img/utils/numThree.jpg" alt="Three" width="54" height="53" onclick="pokeCluster.wrangleData(3)">\n' +
        '            <img src="img/utils/numFour.jpg" alt="Four" width="54" height="53" onclick="pokeCluster.wrangleData(4)">\n' +
        '            <img src="img/utils/numFive.jpg" alt="Five" width="54" height="53" onclick="pokeCluster.wrangleData(5)">\n' +
        '            <img src="img/utils/numSix.jpg" alt="Six" width="54" height="53" onclick="pokeCluster.wrangleData(6)">\n' +
        '            <img src="img/utils/numSeven.jpg" alt="Seven" width="54" height="53" onclick="pokeCluster.wrangleData(7)">\n' +
        '            <img src="img/utils/numEight.jpg" alt="Eight" width="54" height="53" onclick="pokeCluster.wrangleData(8)">'
